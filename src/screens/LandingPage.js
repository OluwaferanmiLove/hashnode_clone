...
function Content() {
  return (
    <div className="main pl-6 pr-6">
      <main>
        <div className="container">
          <div className="logoMain">
            <a>
              <svg class="logo fill-current" viewBox="0 0 688 118" fill="none">
        ...
        <div className="hero">
          <div className="hero-top">
            <div className="hero-text">
              ...
              <p className="mb-hero-p">Starting a blog is an excellent way to share your knowledge, achieve creator independence, and grow your career.</p>
              <p className="mb-hero-p">Hashnode is a free content creation platform and community that easily allows you to publish articles on your own domain.</p>
              <p>This gives you a huge advantage: Google and other search engines send traffic directly to your domain, and Hashnode readers discover your post previews on their feed.</p>
            </div>
            <div className="hero-illustration">
              <HeroIllustration className="illustration" style={{width: "100%", height: "auto"}} />
            </div>
          </div>
        </div>
        <div className="action">
          <a className="action-btn-main">
            <span>Start your personal blog for free ✨</span>
          </a>
          <div className="action-link">
            <a className="action-btn">
              ...
              <span className="text-bold-grey">See what's trending</span>
            </a>
            <a className="action-btn">
              <svg className="icon" viewBox="0 0 24 24">
              ...
              <span class="">
                <strong className="text-bold-grey">Continue without a blog</strong>
                <p className="sub-text">Sign up to read stories and join the conversation with fellow developers with shared interests.</p>
              </span>
            </a>
          </div>
        </div>
